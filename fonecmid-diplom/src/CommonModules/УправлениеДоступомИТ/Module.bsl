...
ОписаниеПрофиля.Идентификатор = "4f0f3e2b-90f6-4d95-b4bc-5139f2b5a101";
...
ОписаниеПрофиля.Идентификатор = "6b0d4bc1-8fc1-4f98-ae89-81e9a0cf2102";
...
ОписаниеПрофиля.Идентификатор = "00c79f7a-fd7f-4d17-bb2e-8fd289f9c303";
...
ОписаниеПрофиля.Идентификатор = "b8e4f1a2-3c5d-4e6f-9a0b-1c2d3e4f5a6b";
ОписаниеПрофиля.Наименование  = НСтр("ru = 'Кадровик-расчетчик'", ОбщегоНазначения.КодОсновногоЯзыка());
ОписаниеПрофиля.Описание      = НСтр("ru = 'Ввод информации о заработной плате и плановых отпусках.'", ОбщегоНазначения.КодОсновногоЯзыка());
ОписаниеПрофиля.Роли.Добавить("ЗапускВебКлиента");
ОписаниеПрофиля.Роли.Добавить("ЗапускТонкогоКлиента");
ОписаниеПрофиля.Роли.Добавить("БазовыеПраваБСП");
ОписаниеПрофиля.Роли.Добавить("ВыводНаПринтерФайлБуферОбмена");
...
ОписаниеПрофиля.Роли.Добавить("СохранениеДанныхПользователя");
ОписаниеПрофиля.Роли.Добавить("ЧтениеНСИ");
ОписаниеПрофиля.Роли.Добавить("ВКМ_ЧтениеЗарплатаИОтпусков");
ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеЗарплатаИОтпусков");
ОписанияПрофилей.Добавить(ОписаниеПрофиля);
//-- ВКМ
КонецПроцедуры
